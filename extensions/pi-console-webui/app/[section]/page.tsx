...
const sections = new Set(["chat", "profiles", "settings", "model", "env", "soul", "context-memory", "guardrails", "skills", "tools", "packages", "pulses", "extensions", "applications", "models", "api-server", "pi-console-webui", "skill-sources"]);
