...
- Cancel an owned active workflow with `sequential_workflow_cancel`. Cancellation does not cascade to descendants; a cancelled child is returned to its parent for evaluation. `/workflow-cancel <id>` remains available for direct user control.
